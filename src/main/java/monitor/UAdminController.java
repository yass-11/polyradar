...
public class UAdminController implements Initializable{
    ...
    @FXML
    void insertAdmin(ActionEvent event) throws SQLException, ClassNotFoundException {
        UAdminDAO.insertAdmin(txtFirstName.getText(),txtLastName.getText(),txtEmail.getText(),txtPassword.getText(),txtFaculty.getText());
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    @FXML
